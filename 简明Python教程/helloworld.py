...
# print(type(s),len(s), s)	#<class 'str'> 20 id=215903184&index=0
# e= s.encode('ascii')
# print(type(e),len(e), e)	#<class 'bytes'> 20 b'id=215903184&index=0'
#
# s = u'id\u003d215903184\u0026index\u003d0'
# print(type(s),len(s), s)	#<class 'str'>  20 id=215903184&index=0
# f=s.encode('utf-8')
# print(type(f),len(f), f)	#<class 'bytes'> 20 b'id=215903184&index=0'
# g = f.decode('utf-8')
# print(type(g),len(g), g)	#<class 'str'>  20 id=215903184&index=0
# s= '\u5FC3 \u60A6 \u4F60'
# print(type(s),len(s), s)        # 心悦你
...
# 集合：集合（Set）是简单对象的无序集合（Collection）。
